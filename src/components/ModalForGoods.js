...
export default function ModalForGoods(props) {
  ...
  return (
   ...
   <View style={{width:'60%',height:190,backgroundColor:"red",borderRadius:10,position:"absolute",top:164,elevation:8, right:-20,transform:[{translateY:yOffset}]}}>
        <TouchableOpacity style={{flexDirection:"row",paddingVertical:8.5,alignItems:"center",paddingTop:17}}>
        <Text style={{paddingHorizontal:10}}>00</Text>
    <Text style={{fontSize:18,}}>Item History</Text>
        </TouchableOpacity>
        <TouchableOpacity style={{flexDirection:"row",paddingVertical:8.5,alignItems:"center"}}>
        <Text style={{paddingHorizontal:10}}>00</Text>
